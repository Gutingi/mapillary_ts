...
SOURCES = \
	__init__.py \
	mapillary_ts.py mapillary_ts_dialog.py

PLUGINNAME = mapillary_ts

PY_FILES = \
	__init__.py \
	mapillary_ts.py mapillary_ts_dialog.py

UI_FILES = mapillary_ts_dialog_base.ui
...
QGISDIR=C:\Users\SteffenHeesch\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
